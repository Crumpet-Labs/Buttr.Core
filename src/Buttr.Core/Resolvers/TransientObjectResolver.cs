...
namespace Buttr.Core {
    internal sealed class TransientObjectResolver<TConcrete> : IResolver, IConfigurable<TConcrete> {
        ...
        internal TransientObjectResolver(Registration registration, Dictionary<Type, Registration> registry) {
            m_Registration = registration;
            m_Registry = registry;
        }

        public void Resolve() {
            m_Registration.Resolver = new TransientResolverInternal<TConcrete>(m_Registry, m_Configuration, m_Factory);
        }
